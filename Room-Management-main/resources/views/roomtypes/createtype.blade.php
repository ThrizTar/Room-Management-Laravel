                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="Information_No" class="form-control" placeholder="Information No">
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="RoomCap" class="form-control" placeholder="Room Capacity">
                            @error('RoomCap')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="Facility_Set" class="form-control" placeholder="Facility Set">
                            @error('Facility_Set')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
